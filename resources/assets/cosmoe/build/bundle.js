...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Vue"] = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(95);
	    Vue.http = __webpack_require__(101);
	    Vue.resource = __webpack_require__(116);
	    Vue.Promise = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlTemplate = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var interceptor = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(94);
	var Promise = __webpack_require__(103);
	var xhrClient = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(94);
	var PromiseObj = window.Promise || __webpack_require__(104);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonpClient = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(94);
	var xdrClient = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/*! Hammer.JS - v2.0.6 - 2016-04-21
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _style=__webpack_require__(138);var _style2=_interopRequireDefault(_style);var _script=__webpack_require__(140);var _script2=_interopRequireDefault(_script);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';"strict mode";var _stringify=__webpack_require__(141);var _stringify2=_interopRequireDefault(_stringify);var _typeof2=__webpack_require__(154);var _typeof3=_interopRequireDefault(_typeof2);var _vuex=__webpack_require__(91);var _vuex2=_interopRequireDefault(_vuex);var _vueStrap=__webpack_require__(117);var _vueStrap2=_interopRequireDefault(_vueStrap);var _vueRouter=__webpack_require__(92);var _vueRouter2=_interopRequireDefault(_vueRouter);var _vueUploadComponent=__webpack_require__(418);var _vueUploadComponent2=_interopRequireDefault(_vueUploadComponent);var _Messages=__webpack_require__(415);var _Messages2=_interopRequireDefault(_Messages);var _Captcha=__webpack_require__(402);var _Captcha2=_interopRequireDefault(_Captcha);var _LoadHtml=__webpack_require__(407);var _LoadHtml2=_interopRequireDefault(_LoadHtml);var _Layout=__webpack_require__(410);var _Layout2=_interopRequireDefault(_Layout);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};} /*!
	 * Version: 0.1.0
	 * Author : LianYue
	 * URL    : http://www.otamoe.com
	 */(function(Vue,Window,Document){Vue.config.debug=true;Vue.config.async=false;Vue.config.devtools=true; // starp 组件
	for(var id in _vueStrap2.default){if(_vueStrap2.default.hasOwnProperty(id)){Vue.component(id=='option'||id=='aside'||id=='select'?'v-'+id:id=='tabset'?'tabs':id,_vueStrap2.default[id]);}}var components={FileUpload:_vueUploadComponent2.default,Messages:_Messages2.default,Captcha:_Captcha2.default,LoadHtml:_LoadHtml2.default};for(var id in components){if(components.hasOwnProperty(id)){Vue.component(id,components[id]);}} // 首字母大写
	Vue.filter('ucfirst',function(value){if(value){value=value.replace(/_/g,' ');value=value.substr(0,1).toUpperCase()+value.substr(1);}return value;});Vue.use({install:function install(Vue,options){ // 表单数据
	Vue.formData=function(form,data){data=data||{};for(var i=0;i<form.length;i++){var input=form[i];if(input.name&&(input.type!='checkbox'||input.checked)){data[input.name]=input.value;}}return data;};}}); // 路由配置
	Window.router=new _vueRouter2.default({history:true,transitionOnLoad:true,linkActiveClass:'active'});if(router.mode=='html5'){if(Window.location.pathname=='/'&&Window.location.hash.substr(0,3)=='#!/'){var pathname=Window.location.hash.substr(2);Window.location.hash='';Window.location.pathname=pathname;return;}}else {if(Window.location.pathname!='/'&&Window.location.hash.substr(0,3)!='#!/'){Window.location='/#!'+Window.location.pathname+window.location.search;return;}}Vue.use({install:function install(Vue,options){var components={};var parseComponent=function parseComponent(contents){try{return new Function('var module = {exports: {}}; var exports = module.exports;   var result = (function(){ '+contents+'; })();  return typeof result == "object" ? result : module.exports;')();}catch(e){console.error(e);return false;}};var parseJavascript=function parseJavascript(contents){try{return new Function(contents+';').call(Window);}catch(e){console.error(e);return false;}};var parseComponentData=function parseComponentData(component,callback){var keywordElement=document.querySelector("head meta[name='keyword']");var descriptionElement=document.querySelector("head meta[name='description']");if(!keywordElement){keywordElement=document.createElement('meta');keywordElement.name='keyword';}if(!descriptionElement){descriptionElement=document.createElement('meta');descriptionElement.name='description';}component.route=component.route||{};var data=function data(transition){callback.call(this,function(data){transition&&transition.next();if(!data){this.$router.app.$broadcast('error',data===null?'Timeout':'Content');return;} // 错误消息
	if(data.messages){this.$broadcast('messages',data);return;}if(data.title){Document.title=data.title.join(' - ');}if(data.keyword){if(typeof data.keyword=='string'){keywordElement.content=data.keyword;}else {keywordElement.content=data.keyword.join(',');}document.querySelector('head').appendChild(keywordElement);}else if(keywordElement.parentNode){keywordElement.parentNode.removeChild(keywordElement);}if(data.description){descriptionElement.content=data.description;document.querySelector('head').appendChild(descriptionElement);}else if(descriptionElement.parentNode){descriptionElement.parentNode.removeChild(descriptionElement);}if(!(data.results instanceof Array)){for(var key in data.results){if(!this.results||!this.results[key]||(0,_typeof3.default)(this.results[key])!='object'||typeof this.results[key].value=='undefined'){continue;}if(!data.results[key]||(0,_typeof3.default)(this.results[key])!='object'||typeof data.results[key].value!='undefined'){continue;}data.results[key].value=this.results[key].value;}}data.csrf=data.csrf||this.csrf;if(this.redirect_uri){data.redirect_uri=this.$route.query.redirect_uri||'/';}this.$data=data;});};if(!component.route.data){component.route.data=data;}else if(component.route.data instanceof Array){component.route.data=[data].concat(component.route.data);}else {component.route.data=[data,component.route.data];}component.routeData=data;return component;};var parseComponentStyle=function parseComponentStyle(component,value){component.route=component.route||{};var style=Document.createElement('style');style.type='text/css';style.textContent=value;var activate=function activate(transition){Document.querySelector('head').appendChild(style);transition.next();};if(!component.route.activate){component.route.activate=activate;}else if(component.route.activate instanceof Array){component.route.activate.push(activate);}else {component.route.activate=[component.route.activate,activate];}var deactivate=function deactivate(transition){style.parentNode&&style.parentNode.removeChild(style);transition.next();};if(!component.route.deactivate){component.route.deactivate=deactivate;}else if(component.route.deactivate instanceof Array){component.route.deactivate.push(deactivate);}else {component.route.deactivate=[component.route.deactivate,deactivate];}return component;};var getHttp=function getHttp(uri,json,callback){Vue.http.get(uri,{pjax:true,json:json?true:undefined},{timeout:15000}).then(callback,callback);};var useSelf=false;Vue.getComponent=function(route,complete){var data={messages:[{message:'Response data'}],success:false};var name=route.name?route.name:route.view?route.view:route.path.split('?')[0];var dataFunction=function dataFunction(callback){if(data!==null){var data2=data;data=null;callback.call(this,data2);return;}var _self=this;getHttp(route.path,true,function(response){if(!response.status){callback.call(_self,null);return;}if(typeof response.data=='string'||response.status>=300&&response.status<400){callback.call(_self,false);return;}callback.call(_self,response.data);});};if(!components[name]&&Window.localStorage['vue-'+name]){var storage=JSON.parse(Window.localStorage['vue-'+name]);var component={};if(storage[0]){component=parseComponent(storage[0]);}if(storage[1]){component.template=storage[1];}if(storage[2]){component=parseComponentStyle(component,storage[2]);}if(storage[3]){parseJavascript(storage[3]);}if(storage[4]){component=parseComponentData(component,dataFunction);}components[name]=component;}var parseBody=function parseBody(contents){if(typeof contents!='string'&&!(contents instanceof Node)){complete(false);return;}if(typeof contents=='string'){var element=Document.createElement('div');element.innerHTML=contents;}else {var element=contents;}var el=element.querySelector('#vue');if(!el){el=element;}var component={};var componentElement=el.querySelector('[type="application/vue"]');var templateElement=el.querySelector('template');var styleElement=el.querySelector('style');var javascriptElement=el.querySelector('[type="text/javascript"]');var dataElement=el.querySelector('[type="application/json"]');el.parentNode&&el.parentNode.removeChild(el);if(componentElement){component=parseComponent(componentElement.textContent);if(!component){complete(false);return;}}if(templateElement){component.template=templateElement.innerHTML;}if(!component.template){complete(false);return;}if(styleElement){component=parseComponentStyle(component,styleElement.textContent);}if(javascriptElement){parseJavascript(javascriptElement.textContent);}if(dataElement){component=parseComponentData(component,dataFunction);data=JSON.parse(dataElement.textContent);}Window.localStorage['vue-'+name]=(0,_stringify2.default)([componentElement?componentElement.textContent:'',templateElement?templateElement.innerHTML:'',styleElement?styleElement.textContent:'',javascriptElement?javascriptElement.textContent:'',dataElement?true:'']);components[name]=component;complete(components[name]);element=undefined;el=undefined;templateElement=undefined;componentElement=undefined;};if(!useSelf&&route.cache!==false&&route.router.mode=='html5'&&!route.uri&&Document.querySelector('#vue template')){useSelf=true;parseBody(Document);return;}if(useSelf&&components[name]&&route.cache!==false){data=null;complete(components[name]);return;}if(!route.uri){useSelf=true;}getHttp(route.uri||route.path,false,function(response){if(!response.status){data=false;complete(null);return;} // 重定向
	parseBody(response.data);});};Vue.prototype.$routeData=function(){this.$options.routeData.call(this);};}});(function(router){ // 重写 uelencode 防止 uri 被encode
	var stringifyPath=router.stringifyPath;var a=Document.createElement('a');router.stringifyPath=function(path){var generatedPath='';if(path&&(typeof path==='undefined'?'undefined':(0,_typeof3.default)(path))==='object'){if(path.name){var extend=Vue.util.extend;var currentParams=this._currentTransition&&this._currentTransition.to.params;var targetParams=path.params||{};var params=currentParams?extend(extend({},currentParams),targetParams):targetParams;for(var key in params){params[key]=encodeURI(params[key]);}generatedPath=this._recognizer.generate(path.name,params);}else if(path.path){generatedPath=path.path;}if(path.query){ // note: the generated query string is pre-URL-encoded by the recognizer
	var query=this._recognizer.generateQueryString(path.query);if(generatedPath.indexOf('?')>-1){generatedPath+='&'+query.slice(1);}else {generatedPath+=query;}}}else {if(path.substr(0,2)=='//'||path.indexOf(':')!=-1){a.href=path;path=a.pathname+a.search+a.hash;}generatedPath=path;}return generatedPath;};router.beforeEach(function(transition){var next=function next(){window.scrollTo(0,0);transition.to.router.app.$refs.error.message='';transition.to.router.app.$broadcast('loading',true);transition.next();}; // 异步加载
	if(transition.to.async){if(!transition.to.async.component){transition.to.router.app.$broadcast('loading',true);Vue.getComponent(transition.to,function(component){if(!component){transition.from.router.app.$broadcast('error',component===null?'Timeout':'Content');transition.from.router.app.$broadcast('loading',false);transition.abort(component===null?'Timeout':'Content');return;}transition.to.async.component=component;next();});}else {next();}}else if(!transition.to.matched){ // 404
	next();}else {next();}});router.afterEach(function(transition){transition.to.router.app.$broadcast('loading',false);});})(router);Document.addEventListener('DOMContentLoaded',function(){var maps={'/account':{component:{template:'<div class="row"><router-view></router-view></div>'},subRoutes:{'/login/':{},'/create/':{},'/lostPassword/':{}}},'/profile':{component:{template:'<router-view></router-view>'},subRoutes:{'/':{},'/setting/':{},'/avatar/':{},'/password/':{},'/log/':{}}}};var routeFunction=function routeFunction(maps){for(var path in maps){if(maps.hasOwnProperty(path)){var map=maps[path];map.path=path;(function(map){if(!map.component){map.async={};map.component=function(resolve){resolve(map.async.component);};}if(map.subRoutes){routeFunction(map.subRoutes);}})(map);}}};routeFunction(maps);router.map(maps);router.start(_Layout2.default,'#app');},false);})(Vue,window,document);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol = __webpack_require__(155)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(158).setDesc
	  , has = __webpack_require__(160)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(174)
	  , getNames  = __webpack_require__(158).getNames
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/loading.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n#loading {\n    z-index: 4097;\n    background: #fff;\n    opacity: .3;\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n}\n", "", {"version":3,"sources":["/./src/vue/loading.vue?367b47ac"],"names":[],"mappings":";AAsBA;IACA,cAAA;IACA,iBAAA;IACA,YAAA;IACA,mBAAA;IACA,OAAA;IACA,UAAA;IACA,QAAA;IACA,SAAA;IACA,YAAA;IACA,aAAA;CACA","file":"loading.vue","sourcesContent":["<template>\n    <div id=\"loading\" v-show=\"show\">\n    </div>\n</template>\n\n<script>\nexport default {\n    data() {\n        return {\n            show: false,\n        }\n    },\n    events: {\n        loading(show) {\n            this.show = show;\n        },\n    },\n}\n</script>\n\n\n<style>\n    #loading {\n        z-index: 4097;\n        background: #fff;\n        opacity: .3;\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        width: 100%;\n        height: 100%;\n    }\n</style>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	//
	// <script>
	exports.default={data:function data(){return {show:false};},events:{loading:function loading(show){this.show=show;}}}; // </script>
	//
	//
	// <style>
	//     #loading {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/barMessages.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/barNotifications.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/barUserMenu.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/barSettings.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/sidebarUserMenu.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/sidebarMenu.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/error.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/error.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./error.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./error.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n#error {\n    z-index: 4095;\n    background: #fff;\n    position: absolute;\n    top: 0;\n    text-align: center;\n    font-size: 18px;\n    line-height: 3.4em;\n    border-bottom: 1px solid #d9d9d9;\n    left: 0;\n    right: 0;\n    width: 100%;\n}\n#error p {\n    margin: 0;\n}\n", "", {"version":3,"sources":["/./src/vue/error.vue?69c7303f"],"names":[],"mappings":";AAQA;IACA,cAAA;IACA,iBAAA;IACA,mBAAA;IACA,OAAA;IACA,mBAAA;IACA,gBAAA;IACA,mBAAA;IACA,iCAAA;IACA,QAAA;IACA,SAAA;IACA,YAAA;CACA;AACA;IACA,UAAA;CACA","file":"error.vue","sourcesContent":["<template>\n    <div id=\"error\" v-show=\"message\">\n        <p>{{message}}</p>\n    </div>\n</template>\n\n\n<style>\n    #error {\n        z-index: 4095;\n        background: #fff;\n        position: absolute;\n        top: 0;\n        text-align: center;\n        font-size: 18px;\n        line-height: 3.4em;\n        border-bottom: 1px solid #d9d9d9;\n        left: 0;\n        right: 0;\n        width: 100%;\n    }\n    #error p {\n        margin: 0;\n    }\n</style>\n\n<script>\nexport default {\n    data() {\n        return {\n            message: '',\n        }\n    },\n    watch: {\n        message(message) {\n            if (message) {\n                var _self = this;\n                setTimeout(function() {\n                    _self.message = '';\n                }, 4000);\n            }\n        }\n    },\n    events: {\n        error(message) {\n            if (message === null) {\n                this.message = '请求超时请重新尝试';\n            } else if (message === false) {\n                this.message = '请求失败请刷新重试';\n            } else {\n                this.message = message;\n            }\n        },\n    },\n}\n</script>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	//
	// <script>
	exports.default={data:function data(){return {message:''};},watch:{message:function message(_message){if(_message){var _self=this;setTimeout(function(){_self.message='';},4000);}}},events:{error:function error(message){if(message===null){this.message='请求超时请重新尝试';}else if(message===false){this.message='请求失败请刷新重试';}else {this.message=message;}}}}; // </script>
	/* generated by vue-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/Captcha.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/Captcha.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Captcha.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Captcha.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	//
	// <script>
	exports.default={props:{src:{type:String},captchaId:{type:String,default:''},title:{type:String,default:'Captcha: '},refreshTitle:{type:String,default:'Refresh captcha'},placeholder:{type:String,default:''},width:{type:String,default:'auto'},height:{type:String,default:'auto'}},methods:{refresh:function refresh(e){if(this.$el){this.$el.querySelector('[name="_captcha"]').value='';}var src=this.src;var r='r='+Math.random().toString();this.src=this.src.replace(/([&?])r\=[^&?]+/,'$1'+r);if(this.src==src){this.src+=(this.src.indexOf('?')==-1?'?':'&')+'_captcha_id='+this.captchaId+'&'+r;}}},events:{captcha:function captcha(){this.refresh();}},created:function created(){this.refresh();}}; // </script>
	//
	//
	// <style>
	//     .captcha img {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/LoadHtml.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/LoadHtml.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	//
	// <script>
	exports.default={props:['url'],data:function data(){return {data:''};},watch:{url:function url(value,oldValue){if(value!=oldValue){this.load();}}},methods:{load:function load(){var _self=this;var url=_self.url;if(!url){_self.data='';}url+=url.indexOf('?')==-1?'?':'&';url+='pjax=true';this.$http({url:url,headers:{'X-Pjax':true},timeout:15000}).then(function(response){_self.data=response.data;},function(){});}},created:function created(){this.load();}}; // </script>
	/* generated by vue-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/Layout.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/Layout.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _barMessages=__webpack_require__(249);var _barMessages2=_interopRequireDefault(_barMessages);var _barNotifications=__webpack_require__(251);var _barNotifications2=_interopRequireDefault(_barNotifications);var _barUserMenu=__webpack_require__(253);var _barUserMenu2=_interopRequireDefault(_barUserMenu);var _barSettings=__webpack_require__(255);var _barSettings2=_interopRequireDefault(_barSettings);var _sidebarUserMenu=__webpack_require__(257);var _sidebarUserMenu2=_interopRequireDefault(_sidebarUserMenu);var _sidebarMenu=__webpack_require__(259);var _sidebarMenu2=_interopRequireDefault(_sidebarMenu);var _loading=__webpack_require__(213);var _loading2=_interopRequireDefault(_loading);var _error=__webpack_require__(261);var _error2=_interopRequireDefault(_error);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};} // <template>
	// <div id="wrapper" :class="{'show-sidebar':sidebar,'hide-sidebar':!sidebar}">
	//     <header id="header" role="banner">
	//         <h1 id="logo">
	//             <a href="/" v-link="'/'" title="标题 - 描述" rel="home">
	...
	//
	// <script>
	exports.default={components:{BarMessages:_barMessages2.default,BarNotifications:_barNotifications2.default,BarUserMenu:_barUserMenu2.default,BarSettings:_barSettings2.default,SidebarUserMenu:_sidebarUserMenu2.default,SidebarMenu:_sidebarMenu2.default,Loading:_loading2.default,Error:_error2.default},data:function data(){return {sidebar:false,user:{profiles:{}}};},watch:{sidebar:function sidebar(value){if(value){var _self=this;setTimeout(function(){_self.$el.querySelector('#sidebar').focus();},50);}}},methods:{openApp:function openApp(e){e.preventDefault();return;}},ready:function ready(){var main=this.$el.querySelector('#main');var footer=this.$el.querySelector('#footer');var resize=function resize(e){main.style.minHeight=(document.documentElement.clientHeight-footer.clientHeight).toString()+'px';};window.addEventListener('resize',resize,true);resize();}}; // </script>
	/* generated by vue-loader */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/Messages.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/lianyue/Project/Loli/resources/assets/cosmoe/src/vue/Messages.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	// </template>
	// <script>
	exports.default={props:{scroll:{type:Number,default:100}},data:function data(){return {success:false,messages:[],response:''};},events:{messages:function messages(data){if(typeof data.status!="undefined"&&typeof data.headers!="undefined"&&typeof data.request!="undefined"){this.response=data;}else {if(typeof data.success=='undefined'){data.success=data.messages==0;}this.success=data.success;this.messages=data.messages;}}},watch:{messages:function messages(_messages){if(this.$refs.alert){if(!this.$refs.alert.show){this.$refs.alert.show=true;}}if(_messages.length&&this.scroll>0){var top=0;var el=this.$el;while(el){top=top+el.offsetTop;el=el.offsetParent;}if(window.scrollY>top||window.scrollY+window.innerHeight-40<top){var bottom=window.scrollY<=top;var Y=window.scrollY;var duration=this.scroll;var timems=Date.now()+duration;var offset=top-20;if(bottom){offset-=window.innerHeight-this.$el.offsetHeight-40;}var scrollX=window.scrollX;var scrollY=window.scrollY;var clear=setInterval(function(){ // 被改动过了
	if(scrollX!=window.scrollX||scrollY!=window.scrollY){clearInterval(clear);return;} // 动画结束
	var now=Date.now();if(timems<now){clearInterval(clear);window.scrollTo(scrollX,offset);return;}var progress=(timems-now)/duration;scrollY=parseInt(offset+(Y-offset)*progress); // 移动
	window.scrollTo(scrollX,scrollY);},16);}}},response:function response(_response){if(!_response){return;}if(!_response.status){this.success=false;this.messages=[{message:'Timeout',code:'timeout'}];return;}var data=_response.data;if(!data){this.success=false;this.messages=[{message:'Response empty',code:'error'}];return;}if(typeof data=='string'){var element=document.createElement('div');element.innerHTML=data;var selectorAll=element.querySelectorAll('#messages p');var messages=[];for(var i=0;i<selectorAll.length;i++){messages.push({message:selectorAll[i].innerText});}this.success=_response.status<400;this.messages=messages;return;}this.success=data.success;this.messages=data.messages;}}}; // </script>
	/* generated by vue-loader */
