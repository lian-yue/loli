...
/*	Author: Moon
/*
/*	Created: UTC 2015-05-24 13:28:29
/*	Updated: UTC 2015-05-30 15:36:30
/*
/* ************************************************************************** */
/**
...
class simple_html_dom_node
{
	...
	function find($selector, $idx=null, $lowercase=false, $call = __FUNCTION__)
	{
		$selectors = $this->parse_selector($selector);
		if (($count=count($selectors))===0) return array();
		$found_keys = array();

		//print_r(HDOM_INFO_BEGIN);
		//die;
		//print_r($count);die;
		// find each selector
